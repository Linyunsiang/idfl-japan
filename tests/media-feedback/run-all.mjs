...
const SUITES = ['zip.test.mjs', 'api.test.mjs', 'anchor.test.mjs', 'admin.test.mjs', 'customer.test.mjs', 'upload.test.mjs', 'normalize.test.mjs', 'stale-read.test.mjs', 'video-package.test.mjs'];
